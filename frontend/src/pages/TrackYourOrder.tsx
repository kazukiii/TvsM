    ...
    <>
      ...
      <div className="h-full text-center">
        ...
        <form className="text-center mt-20">
          ...
          <input
            type="email"
            className="h-10 flex-shrink-0 w-[450px] bg-[#F8F8E4] rounded mt-2"
            style={{ border: '1px solid #CE8C3D' }}
          />
          <h4 className="font-ldr-kaet text-black text-center text-l not-italic font-normal mt-10">Order Number</h4>
          <input
            type="email"
            className="h-10 flex-shrink-0 bg-[#F8F8E4] w-[450px] rounded mt-2"
            style={{ border: '1px solid #CE8C3D' }}
          />
        </form>
        <button
          className="h-[45.964px] mb-20 w-[184.289px] rounded-[8px] bg-yellow-600 mt-3 text-orange-100 text-center text-xl not-italic"
          style={{ border: '2px solid #F8F8E4' }}
        >
          Track
        </button>
        ...
        <p className="font-ldr-kaet text-black text-center text-l not-italic font-normal absolute top-[215px] left-[190px] leading-none">
          CAN’T WAIT TO PLAY<br></br>WITH US HMM??
        </p>
        <p className="font-ldr-kaet text-black text-center text-l not-italic font-normal absolute top-[265px] left-[225px] leading-none">
          HIHIHIHIHI
        </p>
      </div>
