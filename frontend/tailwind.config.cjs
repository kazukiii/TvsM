  ...
  theme: {
    extend: {
      ...
      backgroundImage: theme => ({
        ...
        'kickstarter': "url('/kickstarter.png')",
        'panda-event': "url('/panda-event.png')",
        'ghost-event': "url('/ghost-event.png')",
        'bear-event': "url('/bear-event.png')",
        'swamp-event': "url('/swamp-event.png')",
        'logo-event': "url('/logo-event.png')",
